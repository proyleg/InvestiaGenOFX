...
import static investiagenofx.view.InvestiaGenOFXController.investments;
import java.net.URL;
...
public class InvestmentsSummaryController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        table_tv.setItems(investments); // assign the data to the table
                ...
                TableCell<Investment, Float> cell = new TableCell<Investment, Float>() {
                    ...
                    public void updateItem(Float value, boolean empty) {
                        ...
                        if (value == null) {
                            ...
                            NumberFormat numberForm = NumberFormat.getNumberInstance(Locale.CANADA);
                ...
                TableCell<Investment, Float> cell = new TableCell<Investment, Float>() {
                    ...
                    public void updateItem(Float value, boolean empty) {
                        ...
                        if (value == null) {
                            ...
                            NumberFormat percentageForm = NumberFormat.getPercentInstance(Locale.CANADA);
                            percentageForm.setMinimumFractionDigits(1);
                            setText(percentageForm.format(value/100));
                        }
                    }
                };
                cell.setAlignment(Pos.TOP_RIGHT);
